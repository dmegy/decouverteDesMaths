...
\begin{proposition}[Fibres d'une application]
...
\item Tout ensemble possède la partition $\big\{\: \{x\}\:\mid\: x\in E \:\big\}$. (Si $E$ est vide, la partition est vide).
...
\begin{exercice}[Raffinement d'une partition]
\end{exercice}
...
\begin{remarque} (Zérologie) Le quotient de l'ensemble vide par son unique relation d'équivalence est bien l'ensemble vide.
\end{remarque}
