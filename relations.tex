...
Soient $A$,  $B$ et $C$  des ensembles et $f :  A\to C$, $g : B \to C$ des applications.

Soit $X = A\biguplus B$ la somme disjointe de $A$ et $B$. On définit une relation d'équivalence sur $X$ comme suit:
\[\forall x, y, \in X, x\mathcal R y \iff  
\]
