...
\newtheorem*{exred}{Exemple de rédaction}
\newenvironment{preuve}{{\bf Preuve. }}{$\Box$}
\newenvironment{red}{\begin{exred}~\\\begin{quote}}{\end{quote}\end{exred}}
...
\chapter{Entiers et ensembles finis, combinatoire (EN COURS)}
\input{entiers}
