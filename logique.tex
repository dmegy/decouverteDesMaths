...
Les exerceis suivants portent sur l'élimination des quantificateurs.
2liminer un quantificateur (dans une assertion, aussi appelée \og formule\fg), c'est écrire l'assertion sous une forme équivalente mais dans laquelle le quantificateur a disparu.
