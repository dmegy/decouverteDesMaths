...
%----------------------------------
\section{Composition, réciproques, sections et rétractions}
...
\item D'une part, comme $f$ est surjective, elle admet une section $g$, c'est-à-dire une application $g : F\to E$ telle que $f\circ g = \Id_F$.
