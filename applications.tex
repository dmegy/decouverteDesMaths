...
\begin{exercice}[Union disjointe/somme cartésienne]\label{exo-coproduit}
\index{union disjointe}\index{somme cartésienne}\index{propriété universelle!de la somme cartésienne}
Soient $A$ et $B$ deux ensembles. On appelle \emph{somme cartésienne  de $A$ et $B$} l'ensemble
\[
...
Montrer que $A\coprod B$ ainsi que $i_A$ et $i_B$ vérifient la propriété suivante (dite \emph{propriété universelle  de la somme cartésienne}): 
\begin{quote}
...
\end{quote}
(Remarque : la somme cartésienne de $A$ et de $B$ est aussi fréquemment notée $A\biguplus B$ ou $A\bigsqcup B$ et appelée \emph{union disjointe}. Cette dernière appellation est aussi plus parlante que celle de somme cartésienne, mais elle ne souligne pas la dualité avec la notion de produit cartésien.)
\end{exercice}
